...
.cub file → Parser → Game State → Raycasting → Renderer
...
Calculate ray direction based on player angle

Perform DDA (Digital Differential Analysis) to detect wall collisions

Measure perpendicular wall distance

Calculate projected wall height

Select correct wall texture

Draw the vertical stripe to the screen
...
Walls scale dynamically based on distance

Smooth real-time rendering using MiniLibX
...
These align with project constraints.
